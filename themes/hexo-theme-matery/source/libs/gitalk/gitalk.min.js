	...
	return function (e) {
		...
		*/
		...
		! function () {
			...
			function S(e, t, n) {
				var r, o = B[e.name];
				if (e.prototype && e.prototype.render ? (r = new e(t, n), P.call(r, t, n)) : (r = new P(t, n), r.constructor = e, r.render = E), o)
		...
		var r, o, i, a, u = n(21),
			...
			L = function (e) {
				y.call(s, function () {
					var t;
					M ? E.emit("rejectionHandled", e) : (t = s.onrejectionhandled) && t({
						promise: e,
						reason: e._v
					})
				})
		...
		T || (O = function (e) {
			...
			Promise: O
		}), n(26)(O, "Promise"), n(114)("Promise"), a = n(0).Promise, f(f.S + f.F * !T, "Promise", {
			reject: function (e) {
				var t = k(this);
		...
		var r = n(1),
			...
			q = function (e, t, n) {
				return e === z && q(H, t, n), g(e), t = x(t, !0), g(n), o(B, t) ? (n.enumerable ? (o(e, L) && e[L][t] && (e[L][t] = !1), n = E(n, {
					enumerable: S(0, !1)
